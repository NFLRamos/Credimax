	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'mxu' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'mxu' ); ?></th>
			</tr>
		</thead>
		<tbody>
