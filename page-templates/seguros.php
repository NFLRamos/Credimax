...
<div class="seguros-theme">
	<div class="container-fluid headerPages" style="background-image: linear-gradient(82deg, rgba(0,0,0,1) 0%, rgba(2,2,2,0.7959558823529411) 20%, rgba(10,8,4,0.6727065826330532) 40%, rgba(1,1,1,0.5158438375350141) 60%, rgba(205,152,51,0.0760679271708683) 100%), url(<?php echo $image; ?>); background-position: 50% 60%; background-repeat: no-repeat; background-size: cover;">
		...
		<div class="iconFixed"><img src="<?php echo get_template_directory_uri(); ?>/assets/vida-seguro-svg.svg"></div>
