...
<div class="container-fluid headerPages bg-cover" style="background-image: linear-gradient(82deg, rgba(0,0,0,1) 0%, rgba(2,2,2,0.7959558823529411) 20%, rgba(10,8,4,0.6727065826330532) 40%, rgba(1,1,1,0.5158438375350141) 60%, rgba(205,152,51,0.0760679271708683) 100%), url(<?php echo $image ;?>);"> 
	<div class="row">
		<div class="container container-xxl margem-esq">
			<div class="row">
				<div class="col-12">
					<div class="w-100 py-3">
						<span class="upTitle" ><?php _e('CONHEÇA OS SERVIÇOS');?></span>
					</div>
					<h1><?php the_title(); ?></h1>
