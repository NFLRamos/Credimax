...
if ( ! function_exists( 'mxu_pagination' ) ) {
	/**
	 ...
	 */
	function mxu_pagination( $args = array(), $class = 'pagination' ) {
		...
		$args = wp_parse_args(
			...
			array(
				'mid_size'           => 2,
				'prev_next'          => true,
				'prev_text'          => __( '&laquo;', 'mxu' ),
				'next_text'          => __( '&raquo;', 'mxu' ),
				'type'               => 'array',
				'current'            => max( 1, get_query_var( 'paged' ) ),
				'screen_reader_text' => __( 'Posts navigation', 'mxu' ),
			)
		);
