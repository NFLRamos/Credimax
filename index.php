				...
				<div class="col-12 mt-5">
					...
					<div class="w-75 py-3 text-white">
						...
						<div class="dropdown artigos">
							<button class="btn btn-outline-light catSelector dropdown-toggle mt-5" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
								<?php _e('Todas as categorias'); ?>
							</button>
